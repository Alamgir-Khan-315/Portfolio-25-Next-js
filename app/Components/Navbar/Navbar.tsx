...
const Navbar: React.FC<NavbarProps> = ({ sendDataToParent }) => {
  ...
  return (
    <div className="h-full p-2">
      ...
      <div className="Navbar_icon container mt-[3rem] font-semibold mx-auto flex flex-col items-center gap-1">
        <div
          className="w-full flex gap-2 items-center p-2 px-[2pc] rounded-lg cursor-pointer drop-shadow-lg hover:text-white hover:bg-[#6f36ff]"
          onClick={() => setNav("home")}
        >
          <div>
            <FaHome />
